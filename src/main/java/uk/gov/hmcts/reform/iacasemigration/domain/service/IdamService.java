package uk.gov.hmcts.reform.iacasemigration.domain.service;

import org.springframework.beans.factory.annotation.Value;
import org.springframework.stereotype.Component;
import uk.gov.hmcts.reform.iacasemigration.infrastructure.clients.IdamApi;
...
public class IdamService {
    ...
    public IdamService(
        ...
        @Value("${idam.client.redirect_uri}") String idamRedirectUrl,
